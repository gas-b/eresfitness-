...
def user_input_features():
  ...
  blood_pressure = st.number_input('blood_pressure:', min_value=1, max_value=150, value = 1, step = 0.1)
  sleep_hours = st.number_input('sleep_hours:', min_value=1, max_value=12, value = 1, step = 0.5)
  nutrition_quality = st.number_input('nutrition_quality:', min_value=1, max_value=10, value = 1, step = 0.1)
  activity_index = st.number_input('activity_index:', min_value=1, max_value=4, value = 1, step = 0.01)
